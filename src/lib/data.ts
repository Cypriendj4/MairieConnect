...
const noticesData = [
  { id: 'n1', tenantId: 't_paris', title: 'Travaux rue de la République', content: '<p>Travaux du <strong>15 au 30 septembre 2026</strong>. Circulation alternée.</p>', category: 'travaux', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-paris-centre-75001', modifiedAt: '2026-08-10T00:00:00Z' },
  { id: 'n2', tenantId: 't_paris', title: 'Collecte des déchets verts — Calendrier automne', content: '<p>Calendrier automne : mardi et vendredi 7h-12h. Déchetterie ouverte du lundi au samedi.</p>', category: 'dechets', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-paris-centre-75001', modifiedAt: '2026-08-12T00:00:00Z' },
  { id: 'n3', tenantId: 't_paris', title: 'Alerte canicule — Vigilance orange', content: '<p>Buvez de l\'eau, évitez les sorties 12h-16h. Salle rafraîchie disponible en mairie.</p>', category: 'securite', signType: 'alert', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-paris-centre-75001', modifiedAt: '2026-08-14T00:00:00Z' },
  { id: 'n4', tenantId: 't_lyon', title: 'Réunion publique — Budget participatif', content: '<p>Réunion le 12 septembre à 18h en mairie. Présentation des projets 2026.</p>', category: 'evenement', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-lyon-69001' },
  { id: 'n5', tenantId: 't_lyon', title: 'Marché de Noël — Appel à candidatures', content: '<p>Inscriptions jusqu\'au 15 novembre pour les exposants.</p>', category: 'evenement', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-lyon-69001' },
  { id: 'n6', tenantId: 't_marseille', title: 'Fermeture de la piscine municipale', content: '<p>Fermeture pour travaux du 1er au 30 septembre.</p>', category: 'travaux', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-marseille-13001' },
  { id: 'n7', tenantId: 't_bordeaux', title: 'Marché des producteurs — Saison 2026', content: '<p>Tous les dimanches matin place de la Comédie.</p>', category: 'evenement', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-bordeaux-33000' },
  { id: 'n8', tenantId: 't_lille', title: 'Travaux ligne de métro', content: '<p>Interruption du trafic les 10-11 septembre pour maintenance.</p>', category: 'travaux', signType: 'info', isPublished: true, source: 'manual', sourceUrl: 'https://mairie-connect-ifcn.vercel.app/commune/mairie-de-lille-59000' },
];
