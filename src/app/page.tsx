...
const STATIC_TENANTS_COUNT = 5;
const STATIC_NOTICES_COUNT = 8;
...
async function getData() {
  ...
  return {
    ...
    totalTenants: totalTenants > 0 ? totalTenants : STATIC_TENANTS_COUNT,
    totalNotices: totalNotices > 0 ? totalNotices : STATIC_NOTICES_COUNT,
  };
}
